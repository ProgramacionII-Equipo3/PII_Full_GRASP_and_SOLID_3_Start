...
namespace Full_GRASP_And_SOLID
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            IPrinter filePrinter = new FilePrinter(), consolePrinter = new ConsolePrinter();
            consolePrinter.PrintRecipe(recipe.GetTextToPrint());
            filePrinter.PrintRecipe(recipe.GetTextToPrint());
        }
